...
const ElementBox = ({ element, onClick, isSelected }) => {
    return (
        <div
            className={`element-box ${getCategoryClass(element.category)} ${isSelected ? "ring-4 ring-blue-500 ring-offset-2" : ""}`}
...
function Main({ user, token, onNavigate, onLogout }) {
            ...
            <div className='gle'>
                <div className="bg-gray-100 min-h-screen font-sans text-gray-800">
                    <header>
                        ...
                        <div className="login-join">
                            {token && user ? (
                                ...
                                <>
                                    <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('signin'); }}>
                                        SIGN IN
                                    </a> | 
                    ...
                    <main className="flex flex-col lg:flex-row gap-8 p-6 lg:p-10">
                        <div className="flex-1 w-full border-4 border-blue-500 rounded-xl p-6 flex flex-col items-center">
                            <div className="w-full max-w-full overflow-x-auto">
                                <div id="periodic-table-grid" className="periodic-grid">
